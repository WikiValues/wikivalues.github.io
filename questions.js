questions = [{
	...
	{
		"question": "Я поддерживаю масштабное обновление модулей в рельсе (рейле, правой колонке) в 2017 году, значительно изменившее их дизайн.",
		"effect": {
			"govt": 0,
			"cmnt": 0,
			"jstc": 0,
	...
	{
		"question": "Обновление скинов ФЭНДОМА (например, замена Monaco на Oasis в 2010 году) является прогрессивным и революционным шагом в оформлении викихостинга.",
		"effect": {
			"govt": 0,
			"cmnt": 0,
			"jstc": 0,
