questions = [{
	...
	{
		"question": "Вполне допустимо создание викисоюзов или альянсов, где вся власть сосредоточена в руках 1-2 вики, а остальные лишь подчиняются своим криптократам.",
		"effect": {
			"govt": 0,
			"cmnt": 0,
			"jstc": 0,
