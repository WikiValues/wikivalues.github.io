questions = [{
	...
	{
		"question": "Сильная власть не может исправить недостатки людей.",
		"effect": {
			"govt": 5,
			"cmnt": 0,
			"jstc": 0,
	...
	{
		"question": "Для более эффективной работы википроектов, необходимо орагинзовать систему, при которой одни вики находятся под контролем других и подчиняются их требованиям.",
		"effect": {
			"govt": 0,
			"cmnt": 0,
			"jstc": 0,
	...
	{
		"question": "Сильная концентрация власти в руках малочисленных отдельно взятых википроектов в конечном счёте приведёт к тирании и авторитаризму.",
		"effect": {
			"govt": 5,
			"cmnt": 0,
			"jstc": 0,
	...
	{
		"question": "Я в основном нахожусь и провожу время только на каком-то одном языковом портале ФЭНДОМА (например, на русском).",
		"effect": {
			"govt": 0,
			"cmnt": 0,
			"jstc": 0,
