questions = [{
	...
	{
		"question": "Те, кто больше трудятся, кто вносят больше вклада в развитие вики, должны получать особые привилегии и иметь больше возможностей, по сравнению с остальными участниками.",
		"effect": {
			"govt": -10,
			"cmnt": 0,
			"jstc": 0,
	...
	{
		"question": "Спонтанные действия участников (например, незапланированные правки в статьях) более эффективны, чем тщательно спланированные.",
		"effect": {
			"govt": 0,
			"cmnt": -10,
			"jstc": 0,
	...
	{
		"question": "Каждый участник вправе поступать так, как считает нужным и правильным лично он сам.",
		"effect": {
			"govt": 0,
			"cmnt": -10,
			"jstc": 0,
